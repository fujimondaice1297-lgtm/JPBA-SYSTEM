...
- `progress_board.md`: 未チェック 41 件（2026-06-26整理後、OCR/AI取込詳細の確認情報表示とOCRエンジン接続境界固定を完了）
...
- 整理後の未チェックは43件。その後、OCR/AI変換結果の警告・信頼度・変換元行の表示改善と、実OCRエンジン接続境界固定を完了し、現在の未チェックは41件。
