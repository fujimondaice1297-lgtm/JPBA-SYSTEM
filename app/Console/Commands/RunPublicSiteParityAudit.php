...
class RunPublicSiteParityAudit extends Command
{
    ...
    private function publicPages(): array
    {
        return [
            ...
            ['page' => 'protest', 'path' => '/protest', 'required' => ['プロテスト', '過去のプロテスト結果', '2008年度', '2026年度']],
            ['page' => 'protest-history-2026', 'path' => '/protest/history/2026', 'required' => ['2026年度 プロテスト結果', '最終結果・合格者', '第1次テスト', '第2次テスト']],
            ['page' => 'protest-history-2020', 'path' => '/protest/history/2020', 'required' => ['2020年度 プロテスト結果', '2020年度のプロテストは中止']],
