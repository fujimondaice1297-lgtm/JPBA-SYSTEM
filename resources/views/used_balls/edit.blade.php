        ...
        <div class="card-body">
            <div class="row g-3 small">
                <div class="col-md-3">
                    ...
                    <div>{{ \App\Support\PublicLicenseNumber::format($usedBall->proBowler?->license_no) }}</div>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <div>{{ $usedBall->approvedBall?->registration_brand ?? '' }} {{ $usedBall->approvedBall?->name ?? '' }}</div>
                </div>
                <div class="col-md-3">
