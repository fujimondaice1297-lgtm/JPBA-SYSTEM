...
<div class="container">
    ...
    <a href="{{ route('tournaments.prize_distributions.create', $tournament->id) }}" class="btn btn-success">新規作成</a>
    <a href="{{ route('tournaments.index') }}" class="btn btn-secondary ">大会一覧に戻る</a>
    <a href="{{ route('tournaments.prize_distributions.create', $tournament->id) }}" class="btn btn-success">順位を追加する</a>
    <table class="table table-bordered">
        ...
        <tbody>
            @foreach($prizeDistributions as $pd)
                <tr>
                    <td>{{ $pd->rank }}</td>
